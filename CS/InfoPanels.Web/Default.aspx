    ...
    <div id="PageContent" class="PageContent" style="height: 100%">
        <form id="form2" runat="server">
            <div style="height: 100%">
                ...
                <dx:ASPxSplitter ID="Spl" runat="server" Width="100%" Height="100%" Orientation="Vertical"
                    FullscreenMode="true" SaveStateToCookiesID="SeparatorPosDefault" SaveStateToCookies="true">
                    <panes>
                    ...
                    <dx:SplitterPane AllowResize="False" Separator-Visible="False">
                        <Panes>
                          ...
                          <dx:SplitterPane Name="Right" ShowCollapseForwardButton="True" Size="300px" PaneStyle-Paddings-Padding="1px" PaneStyle-BorderRight-BorderStyle="None">
                           <ContentCollection>
                             <dx:SplitterContentControl ID="SCC2" runat="server"/>
                           </ContentCollection>        
                          </dx:SplitterPane>                    
                        </Panes>
                    </dx:SplitterPane>
