						...
						<table id="MRC" style="width: 100%" cellpadding="0" cellspacing="0">                            
							<tr>
								...
								<td id="separatorCell" style="width: 6px; border-bottom-style: none; border-top-style: none;
									...
									<div id="separatorButton" class="dxsplVSeparatorButton_<%=CurrentTheme%>" onmouseover="OnMouseOver('separatorButton')"
										 onmouseout="OnMouseOut('separatorButton')" onclick="OnClick('LPcell', 'separatorImage', true)">
								...
								<td id="RS" style="width: 6px; border-bottom-style: none; border-top-style: none" class="dxsplVSeparator_<%=Theme%> dxsplPane_<%=Theme%> ">
									<div id="RSB" class="dxsplVSeparatorButton_<%=Theme%>" onmouseover="OnMouseOver('RSB')" onmouseout="OnMouseOut('RSB')" onclick="OnClick('Right', 'RSI')" >
										<div id="RSI" style="width: 6px;" class="dxWeb_splVCollapseForwardButton_<%=Theme%>">
										</div>
									</div>
								</td>
								<td id="Right" runat="server" width="250px" style="vertical-align: top">
